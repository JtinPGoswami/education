  ...
  return (
    <div className="space-y-2 box-border flex sm:flex-row flex-col justify-start gap-4  p-2 mx-2 rounded-lg border-2 sm:border-transparent shadow-2xl border-[#77d693]   hover:border-t-[#77d693] group transition-colors ease-linear duration-700 sm:h-36 sm:py-0 py-2">
      <img
        src={college.logo}
        alt=""
        className="sm:w-[40%] sm:h-auto w-50 h-50 mx-auto"
      />
      <div className="w-full">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="px-3 sm:group-hover:block sm:hidden transition-all duration-200 ease-linear cursor-pointer bg-green-500 text-white py-1 rounded-lg hover:bg-green-600  lg:text-base text-sm"
          >
            View Detail
          </button>
        </div>
